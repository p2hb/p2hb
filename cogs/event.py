...
class Event(commands.Cog):
    ...
    async def eventcollect(self, ctx):
        ...
        embed = discord.Embed(title = "Here, have some free money", description="You have been given 500 tokens. If you would like to add the bot to your own server, use http://invite.p2hb.me/")
